...
const Segments: React.FC = () => {
  ...
  try {
    ...
    // FIXED: For AI method, always include both rules AND nlpQuery
    if (createMethod === 'ai') {
      ...
      // CRITICAL FIX: Include rules if they were generated by AI
      if (rules && rules.conditions && rules.conditions.length > 0) {
        payload.rules = rules;
      }
    } else {
      // Manual method - validate rules
      if (!isValidRules() || !rules) {
        toast.error('Please define segment rules');
        return;
      }
      payload.rules = rules;
    }
