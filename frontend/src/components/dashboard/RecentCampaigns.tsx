    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      ...
      {campaigns.length === 0 ? (
        <div className="text-center py-8">
          ...
          <p className="text-gray-500 mb-4">No campaigns have been created yet.</p>
          <Link to="/campaigns">
        ...
        <div className="space-y-4">
          {campaigns.map((campaign: Campaign) => {
            ...
            const successRate =
              totalMessages > 0 ? ((sentCount / totalMessages) * 100).toFixed(0) : '0';
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
                    <div className="flex items-center space-x-1" title="Audience Size">
                    ...
                    <div className="flex items-center space-x-1" title="Success Rate">
                      <TrendingUp className="w-4 h-4" />
                      <span>{successRate}%</span>
                    </div>
                    <div className="flex items-center space-x-1" title="Created">
                ...
                <div className="text-right flex-shrink-0">
                  <div className="text-sm font-medium text-gray-900">{sentCount.toLocaleString()} sent</div>
                  <div className="text-xs text-gray-500">{failedCount} failed</div>
                </div>
              </div>
            );
          })}
