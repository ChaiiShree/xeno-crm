  ...
  const features = [
    {
      ...
      description: 'AI-powered customer segmentation with natural language queries'
    },
    {
      icon: Mail,
      title: 'Campaign Management',
      description: 'Create and manage personalized email campaigns with ease'
    },
    {
      icon: BarChart3,
      title: 'Advanced Analytics',
      description: 'Detailed insights and performance metrics for your campaigns'
    },
    {
      icon: Shield,
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600 text-lg">
                  Build targeted segments, create personalized campaigns, and drive meaningful engagement with your customers.
                </p>
              </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <button
                        ...
                        className="w-full bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 text-gray-700 py-4 px-6 rounded-2xl transition-all duration-300 flex items-center justify-center space-x-3 font-medium shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                      >
